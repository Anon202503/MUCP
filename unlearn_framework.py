...
def training_step_cp_loss(model, batch, criterion, q_hat, delta, lamda, device, unlearn_type, unlearn_name):
...
def fit_one_cycle(
    epochs, model, train_loader, forget_loader, test_loader, cal_dl, device, delta, alpha, lamda, lr, unlearn_type, milestones, unlearn_name='retrain'
):
...
def RL(
    ...
    **kwargs,
    ...
    fit_one_cycle(
        ...
        lr=learning_rate, unlearn_type=unlearn_type, milestones=milestones, unlearn_name=unlearn_name
    )
